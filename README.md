...
** My Solution ** I fixed bug 1 by going to the dropdown container on line 94. on line 96 I then saw postion was set to fixed. I changed this to auto to make the dropdown scroll with the rest of the page. 
...
**My Solution** I was able to get the check box to work with in the CSS. On line 154-155 I change display from none to block. This created a box to toggle on and off. 
...
**My Solution** I first went to the console to find where this function was. I searched and found in requests.ts there is a getTransactionsByEmplyee function. I fixed the error from triggering by adding an all employees to be filter with out checking the employee IDs. 
...
**MY Solution** 
I went to the gettransctionsPaginated in request.ts and i added a slice method. This took the part of the array being shown. I then used concat to combined the newData and oldData.
